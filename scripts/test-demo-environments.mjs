...
import { REST_VERSION } from './lib/treetop-contract.mjs'
...
const binary = await ensureTreetopServer({ root })
...
console.log(`\n${environments.length} demo environments passed against treetop-rest ${REST_VERSION}.`)
